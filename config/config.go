...
type HTTPProbe struct {
	...
	FailIfBodyJsonNotMatchesCEL  *CELProgram             `yaml:"fail_if_body_json_not_matches_cel,omitempty" json:"fail_if_body_json_not_matches_cel,omitempt"`
	...
	UseHTTP3                     bool                    `yaml:"enable_http3,omitempty" json:"enabled_http3,omitempty"`
}
